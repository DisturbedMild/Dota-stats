...
const AghanimPopupDescription = ({ dname, img, attrib, desc }: Ability) => {
  return (
    <div className="flex flex-col p-1 w-[300px] cursor-pointer z-10 border border-gray-900 bg-slate-800">
      ...
      <div className="mt-1 p-2 bg-slate-700">
        ...
        <p className="mt-2 text-xxs text-white mb-2 pb-2 border-b border-gray-900">
          {desc}
        </p>
        {attrib.map((attr, i) => {
          return (
            <div
              ...
              className="flex text-xxs text-white"
            >
              <div>{attr.header}</div>
              &nbsp;
...
export default AghanimPopupDescription;
